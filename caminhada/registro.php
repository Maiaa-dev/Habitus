<?php 
    ...
    if (isset($_POST['opcao'])) {
        ...
        $sql = "SELECT m.nome_meta,m.id_meta FROM metas m, usuario u, habito_usuario hu, habitos h WHERE m.id_meta = hu.id_meta and u.id_usuario = hu.id_usuario and h.id_habito = hu.id_habito and hu.id_usuario = '$idUsuario' and hu.id_habito = 3";
        ...
        $sql = "SELECT rc.meta_cumprida FROM registros_caminhada rc, usuario u WHERE rc.id_usuario = u.id_usuario and rc.id_habito = 3 and DATE(data_feito) = CURDATE()";
